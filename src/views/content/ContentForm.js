  ...
  const submission = async () => {
    ...
    if (title.length === 0) {
      ...
      swal.fire({
        ...
        if (res.isConfirmed) {
          try {
            let result = await ContentModel.create({
              title,
            ...
            if (result.id || result.success) {
              await swal.fire('', "Data sucessfuly stored", 'success')
                .then(() => {
        ...
        <CCard style={{...Styles.cardForm}} className="mb-4">
          ...
          <CCardBody>
            <CForm
              ...
              <CRow className="mb-3">
                <CFormLabel style={{...Styles.formLabel}} htmlFor="inputTitle" className="col-sm-2 col-form-label">
                  Title
                </CFormLabel>
                <div className="col-sm-10">
                  <CFormInput onChange={(e) => setTitle(e.target.value)} type="text" id="inputTitle"/>
                </div>
              </CRow>
              <CRow className={'mb-3'}>
                <div className="col-md-12">
                  ...
                  <ImageDropzone
                    ...
                    prompt={<>Add Thumbnail <br/> (Recommendation 400*400)</>}
                ...
                <div className="col-md-12">
                  ...
                  <ImageDropzone
                    ...
                    prompt={<>Add Banner <br/></>}
                    onDrop={acceptedFiles => onBannerPicked(acceptedFiles)}
                  />
                </div>
              </CRow>
              <CRow className="mb-3">
                <CFormLabel style={{...Styles.formLabel}} htmlFor="inputContent" className="col-sm-2 col-form-label">
                  Content
                </CFormLabel>
                <div
                  style={{
